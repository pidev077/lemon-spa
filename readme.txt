...
2. Type "lemon Elementor" in the search field.
...
* `lemon_elementor_enqueue_style`                 enqueue style
* `lemon_elementor_enqueue_theme_style`           load theme-specific style (default: load)
* `lemon_elementor_load_textdomain`               load theme's textdomain
* `lemon_elementor_register_menus`                register the theme's default menu location
* `lemon_elementor_add_theme_support`             register the various supported features
* `lemon_elementor_add_woocommerce_support`       register woocommerce features, including product-gallery zoom, swipe & lightbox features
* `lemon_elementor_register_elementor_locations`  register elementor settings
* `lemon_elementor_content_width`                 set default content width to 800px
* `lemon_elementor_page_title`                    show\hide page title (default: show)
* `lemon_elementor_viewport_content`              modify `content` of `viewport` meta in header

== Frequently Asked Questions ==

**Does this theme support any plugins?**

lemon Elementor includes support for WooCommerce.
...
lemon Elementor bundles the following third-party resources:
...
= 2.6.1 - 2022-07-11 =
* Tweak: Tables looks weird on dark backgrounds ([#126](https://github.com/elementor/lemon-theme/issues/126))
* Fix: Remove unnecessary PHP tags ([#213](https://github.com/elementor/lemon-theme/issues/213))

= 2.6.0 - 2022-07-10 =
* Tweak: Added `theme_support` for `script` and `style` to avoid validation warnings ([#184](https://github.com/elementor/lemon-theme/issues/184))
* Tweak: Sanitized content for allowed HTML tags in post title ([#118](https://github.com/elementor/lemon-theme/issues/118))
...
* Fix: Added output escaping in several places ([#194](https://github.com/elementor/lemon-theme/issues/194))
* Fix: Post Password Form Submit button alignment (Props [@romanbondar](https://github.com/romanbondar))
* Fix: Fatal error when kit doesn't exist or needs to be recreated ([#175](https://github.com/elementor/lemon-theme/issues/175))

= 2.5.0 - 2022-01-26 =
* Tweak: Added keyboard navigation to lemon theme menus
* Tweak: Added Skip Links and `#content` for the main wrapper for better accessibility ([#133](https://github.com/elementor/lemon-theme/issues/133))
...
* Tweak: Remove comments in `style.min.css` output ([#179](https://github.com/elementor/lemon-theme/issues/179))
* Tweak: Promoted lemon Theme Header & Footer experiment status to Stable
* Tweak: Added compatibility for upcoming WordPress version 5.9

= 2.4.1 - 2021-07-07 =
* Fix: lemon Theme Header & Footer experiment should be inactive for existing sites
...
* Tweak: Added `input[type="url"]` to CSS reset rules ([#109](https://github.com/elementor/lemon-theme/issues/109))
...
= 2.2.1 - 2019-09-10 =
* Tweak: Added max width to `wp-caption` ([#91](https://github.com/elementor/lemon-theme/issues/91))
* Tweak: Added support of `wp_body_open`

= 2.2.0 - 2019-07-22 =
* Tweak: Added viewport content filter ([#49](https://github.com/elementor/lemon-theme/issues/49))
...
* Tweak: Remove header tags with `lemon_elementor_page_title` filter
...
* New: Added `lemon_elementor_page_title` filter for show\hide page title
* New: Added `lemon_elementor_enqueue_theme_style` filter for enqueue theme-specific style
...
= 2.0.5 - 2019-05-21 =
* New: Inroducing [lemon Theme Child](https://github.com/elementor/lemon-theme-child)
...
= 2.0.2 - 2019-05-13 =
* Tweak: Added `lemon_elementor_content_width` filter, as per WordePress best practice
...
* Tweak: Change functions.php methods names prefix from `lemon_elementor_theme_` to `lemon_elementor_`
...
* New: Added `elementor_lemon_theme_load_textdomain` filter for load theme's textdomain
* New: Added `elementor_lemon_theme_register_menus` filter for register the theme's default menu location
* New: Added `elementor_lemon_theme_add_theme_support` filter for register the various supported features
* New: Added `elementor_lemon_theme_add_woocommerce_support` filter for register woocommerce features, including product-gallery zoom, swipe & lightbox features
* New: Added `elementor_lemon_theme_enqueue_style` filter for enqueue style
* New: Added `elementor_lemon_theme_register_elementor_locations` filter for register elementor settings
